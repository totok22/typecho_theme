...
1. 修复目录展开/折叠按钮第一次点击无反应的问题
2. 修复宽屏下切换文章后目录残留旧文章内容的问题
3. 移除目录常驻/隐藏切换按钮，简化交互
4. 优化目录布局：文章详情页目录在右侧侧边栏，其他侧边栏内容移到文章下方
5. 列表页保持原有侧边栏布局（最新文章、文章合集等在右侧显示）
6. 修复行内代码样式污染代码块样式的问题
7. 宽屏模式添加目录折叠/展开按钮
8. 目录跟随文章滚动自动滑动，优化向上滑动效果
9. 修复PJAX导航时侧边栏不更新的问题
